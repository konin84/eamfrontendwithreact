...
export const updateClient = (id, user) => {
  return axios.put(API_URL + "/account/client/" + id, user, {
    headers: AuthHeader(),
    head,
  });
};
...
export const deleteClient = (id) => {
  return axios.delete(API_URL + "/public/user/delete/" + id, {
    headers: AuthHeader(),
  });
};
...
export const allClients = () => {
  return axios.get(API_URL + "/account/clients", {
    headers: AuthHeader(),
  });
};
