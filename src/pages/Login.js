  ...
  return (
    ...
    <section className="bg-gray-900 h-screen w-screen relative overflow-hidden flex flex-col justify-center items-center py-60 ">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-indigo-700 bg-black shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl animate-pulse"></div>
